...
xpath["use_the_app"] = {
    "use_the_app_body_xpath": '//*[@id="react-root"]/section/div[2]',
    "close_button": '//*[@id="react-root"]/section/div[2]/div/div[1]/button'
}

xpath["unfollow_users"] = {
    "latest_posts": "//article/div[1]/div/div[1]/div[1]/a",
    "latest_posts_date": "//a/time",
    "follow_stats_confirmation": "//button/div/span[contains(@aria-label, 'Following')]",
    "confirm_unfollow": "//button[text()='Unfollow']"
}

xpath["get_following_users"] = {
    "following_botton": '//ul/li[3]/a/span'
}


xpath["home_screen"] = {
    "offer_elem_loc": "//div/h2[text()='Add Instagram to your Home screen?']",
    "dismiss_elem_loc": "//button[text()='Cancel']",
}
